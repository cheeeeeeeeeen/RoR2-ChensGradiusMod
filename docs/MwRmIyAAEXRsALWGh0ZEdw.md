...
| [InitializeDroneModelComponents(GameObject, CharacterBody, bool)](65t1Oatg+D3hpjEh9bp02A 'Chen.GradiusMod.Extensions.InitializeDroneModelComponents(UnityEngine.GameObject, RoR2.CharacterBody, bool)') | Shortcut for initializing a custom drone model. Only applies when work flow is followed the same as this mod's drones.<br/> |
